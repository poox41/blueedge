  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg border border-[#E5E6EB] overflow-hidden">
        ...
        <TableBody>{isLoading ? (<TableRow><TableCell colSpan={5} className="text-center py-16 text-[#86909C] text-sm">加载中...</TableCell></TableRow>) : paginated.length === 0 ? (<TableRow><TableCell colSpan={5} className="text-center py-16 text-[#86909C] text-sm">暂无服务账户数据</TableCell></TableRow>) : paginated.map(row => (
